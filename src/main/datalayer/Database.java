...
public class Database {
	...
	private static final String url = "jdbc:mysql://localhost:3306/blog"; //the url is unique for each db
	private static final String user =" root";         
	private static final String password = "root";  
	
	public static Article getById(int id) {
		try {
			Class.forName("com.mysql.jdbc.Driver");  //include these drivers in WEB_INF lib folder(a jar file)
